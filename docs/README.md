...
## Active (operator + contract docs)

- `runbook.md` — canonical daily/operator commands.
- `scheduled-flow.md` — scheduled execution examples.
- `contracts.md` — report/brief/backtest/CLI output contracts.
- `sources.md` — source policy and health expectations.
- `credits.md` — quota and spend guidance.
